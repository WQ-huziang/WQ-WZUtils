...
inline struct CThostFtdcInputOrderField parseFrom(char *buffer)
{
	struct CThostFtdcInputOrderField res;
	memset(&res, 0, sizeof(res));
	memcpy(&res, buffer, sizeof(buffer));
	cout << res.BrokerID << endl;
	cout << res.InvestorID << endl;
	cout << res.LimitPrice << endl;
	return res;
}

inline struct CThostFtdcInputOrderActionField parseTo(char *buffer)
{
